...
<head>
<meta charset="UTF-8">
<title>EL구문 짱 좋아요</title>
</head>
<body>

	<h1>EL구문 배울 거임 진짜 좋아요</h1>
	...
	<p>
		...
		<!-- 
			...
			해당 필드의 네이밍컨벤션에 부합하는 getter를 찾아서 호출해줌.
		 -->
	</p>
	...
	다시 출력해보기 : ${ key } <br> <%-- 밑에 있는 친구일수록 우선순위가 높아요! --%>
	...
	<!-- 
		...
		모든 영역에 키가 존재하지 않는다면 예외가 발생하겠지만
		EL구문 같은 경우에는 아무 일도 일어나지 않음. (오류가 안남)
		근데 오류가 나면 고치면 되는데 안나와버리면 갸우뚱ㅠ_ㅠ
	 -->
	...
	<p>
		...
		big / small = ${ big / small }<br> 또는 ${ big div small }<br>
		big % small = ${ big % small }<br> 또는 ${ big mod small }<br>
	</p>
